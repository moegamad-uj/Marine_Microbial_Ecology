...
# Calculate NMDS stress for subtitle
...
ggplot(nmds_scores, aes(x = NMDS1, y = NMDS2, color = Mean_Salinity_PSU, shape = Ocean_sea_regions)) +
  geom_point(size = 3.5, alpha = 0.85, stroke = 0.2) +
  ...
  geom_text(
    ...
    color = "navy", size = 5, fontface = "bold", hjust = 0.5, inherit.aes = FALSE
  ) +
  theme_classic(base_size = 16) +
  labs(
    title = "NMDS Ordination with Significant Environmental Vectors",
    subtitle = paste0("Trade Wind Biomes at Deep Chlorophyll Maximum (Stress = ", nmds_stress, ")"),
    x = "NMDS1",
    y = "NMDS2",
